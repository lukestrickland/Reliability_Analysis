...
```{r echo= FALSE}
Vs_cap <- "Figure 6. Estimates of accumulation rates. The shapes indicate the posterior means and the error bars correspond to the mean plus or minus the posterior standard deviation."
```
...
percents <- 100*combined$mean/combined$data
...
Figures 10 and 11 depict the results of our posterior exploration. The full model provided good fits to automation’s effects on accuracy when inhibition was removed for both high (`r percents[1]`%) and low (`r percents[2]`%) reliability conditions. Similarly, the full model provided
reasonably good fits to the costs of automation in the high (`r percents[3]`%) and low (`r percents[4]`%) reliability conditions. In contrast, removing inhibition from the model left the model far less 
predictive of automation benefits in the high-reliability condition (`r percents[5]`%), automation costs in the high-reliability condition (`r percents[6]`%)automation benefits in the low-reliability condition (`r percents[7]`%), automation costs in the low-reliability condition (`r percents[8]`%). This demonstrates the significant role that inhibition played in the benefits and costs of automation in both conditions.




We found major miss-fits to , and also major miss-fits to accuracy effects for the high-reliability condition when excitation was removed. This suggests that inhibition was important for explaining automation’s effects on accuracy in both conditions, and excitation important in the high-reliability condition. We also found that removing inhibition from the model caused major miss-fits to the effects of automation on RT, particularly costs of incorrect automation to RT, demonstrating the importance of the inhibition mechanism in driving this cost . In contrast to these findings, setting thresholds to manual levels had little effect on predictions regarding automation’s effect, suggesting they were relatively less important to model predictions.   
