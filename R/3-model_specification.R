...
CA_top_thresholdsmult_simple_p.prior <- prior.p.dmc(
  ...
  p2=c(1,1,1,rep(1, 22), rep(2, 24)),
  lower=c(0.1, 0,0, rep(0, 22), rep(NA, 24)),
...
save(CA_top_thresholdsmult_simple_samples,
     file="CA_top_thresholdsmult_simple_samples.RData")
...
CA_top_goodpriormodel <- model.dmc(
  p.map = list(
    A = "1",B = c("cond", "sess", "R"), t0 = "1", mean_v = c("S", "cond", "failtrial", "M"),
    sd_v = c("M"), st0 = "1"),
  match.map = list(
...
pnames <- attr(CA_top_goodpriormodel, "p.vector")
...
CA_top_goodpriorp.vector[3] <- 0.79

CA_top_goodpriorp.vector[4:21] <- c(1.71, 1.71, 1.71, 
                                    1.23, 1.23, 1.23, 
                                    1.23, 1.23, 1.23, 
                                    2.07, 2.07, 2.07,
                                    1.59, 1.59, 1.59,
...
CA_top_goodpriorp.vector[22:45] <- c(1.67, 1.63, 1.67, 1.63,1.67, 1.63,
...
check.p.vector(CA_top_goodpriorp.vector, CA_top_goodpriormodel)

CA_top_goodpriorp.prior <- prior.p.dmc(
  dists = rep("tnorm", length(CA_top_goodpriorp.vector)),
  p1=CA_top_goodpriorp.vector,                           
  p2=c(1,1,1,rep(1, 18), rep(2, 24)),
  lower=c(0.1, 0,0, rep(0, 18), rep(NA, 24)),
  upper=c(5,10, rep(Inf, length(CA_top_goodpriorp.vector)-2))
)

CA_top_goodpriordm <- data.model.dmc(cleandats,
                            CA_top_goodpriormodel)

CA_top_goodpriorp.vector

CA_top_goodpriorsamples <- h.samples.dmc(nmc = 180,
                                CA_top_goodpriorp.prior,
                                CA_top_goodpriordm, thin=20)

CA_top_goodpriorp.vector

save(CA_top_goodpriorsamples, file="CA_top_goodpriorsamples.RData")
...
CA_top_goodpriorstrongmodel <- model.dmc(
  p.map = list(
    A = "1",B = c("cond", "sess", "R"), t0 = "1", mean_v = c("S", "cond", "failtrial", "M"),
    sd_v = c("M"), st0 = "1"),
  match.map = list(
...
pnames <- attr(CA_top_goodpriorstrongmodel, "p.vector")
...
CA_top_goodpriorstrongp.vector  <- 
  pnames[c(
    names(pnames)[grep("t0", names(pnames))],
    names(pnames)[grep("A", names(pnames))],
    names(pnames)[grep("sd_v", names(pnames))],
...
CA_top_goodpriorstrongp.vector[3] <- 0.79

CA_top_goodpriorstrongp.vector[4:21] <- c(1.71, 1.71, 1.71, 
                                    1.23, 1.23, 1.23, 
                                    1.23, 1.23, 1.23, 
                                    2.07, 2.07, 2.07,
                                    1.59, 1.59, 1.59,
...
CA_top_goodpriorstrongp.vector[22:45] <- c(1.67, 1.63, 1.67, 1.63,1.67, 1.63,
                                     1.67, 1.63, 1.67, 1.63,1.67, 1.63,
                                     -0.61, -1.38,-0.61, -1.38,-0.61, -1.38,
                                     -0.61, -1.38,-0.61, -1.38,-0.61, -1.38
...
check.p.vector(CA_top_goodpriorstrongp.vector, CA_top_goodpriorstrongmodel)

CA_top_goodpriorstrongp.prior <- prior.p.dmc(
  dists = rep("tnorm", length(CA_top_goodpriorstrongp.vector)),
  p1=CA_top_goodpriorstrongp.vector,                           
  p2=c(0.5,0.5,0.5,rep(0.5, 18), rep(1, 24)),
  lower=c(0.1, 0,0, rep(0, 18), rep(NA, 24)),
  upper=c(5,10, rep(Inf, length(CA_top_goodpriorstrongp.vector)-2))
)

CA_top_goodpriorstrongdm <- data.model.dmc(cleandats,
                                     CA_top_goodpriorstrongmodel)

CA_top_goodpriorstrongp.vector

CA_top_goodpriorstrongsamples <- h.samples.dmc(nmc = 180,
                                         CA_top_goodpriorstrongp.prior,
                                         CA_top_goodpriorstrongdm, thin=20)

CA_top_goodpriorstrongp.vector

save(CA_top_goodpriorstrongsamples, file="CA_top_goodpriorstrongsamples.RData")
...
CA_top_goodpriorweakmodel <- model.dmc(
  p.map = list(
    A = "1",B = c("cond", "sess", "R"), t0 = "1", mean_v = c("S", "cond", "failtrial", "M"),
    sd_v = c("M"), st0 = "1"),
  match.map = list(
...
pnames <- attr(CA_top_goodpriorweakmodel, "p.vector")
...
CA_top_goodpriorweakp.vector[3] <- 0.79

CA_top_goodpriorweakp.vector[4:21] <- c(1.71, 1.71, 1.71, 
                                    1.23, 1.23, 1.23, 
                                    1.23, 1.23, 1.23, 
                                    2.07, 2.07, 2.07,
                                    1.59, 1.59, 1.59,
...
CA_top_goodpriorweakp.vector[22:45] <- c(1.67, 1.63, 1.67, 1.63,1.67, 1.63,
                                     1.67, 1.63, 1.67, 1.63,1.67, 1.63,
                                     -0.61, -1.38,-0.61, -1.38,-0.61, -1.38,
                                     -0.61, -1.38,-0.61, -1.38,-0.61, -1.38
...
check.p.vector(CA_top_goodpriorweakp.vector, CA_top_goodpriorweakmodel)

CA_top_goodpriorweakp.prior <- prior.p.dmc(
  dists = rep("tnorm", length(CA_top_goodpriorweakp.vector)),
  p1=CA_top_goodpriorweakp.vector,                           
  p2=c(2,2,2,rep(2, 18), rep(4, 24)),
  lower=c(0.1, 0,0, rep(0, 18), rep(NA, 24)),
  upper=c(5,10, rep(Inf, length(CA_top_goodpriorweakp.vector)-2))
)

CA_top_goodpriorweakdm <- data.model.dmc(cleandats,
                                     CA_top_goodpriorweakmodel)

CA_top_goodpriorweakp.vector

CA_top_goodpriorweaksamples <- h.samples.dmc(nmc = 180,
                                         CA_top_goodpriorweakp.prior,
                                         CA_top_goodpriorweakdm, thin=20)

CA_top_goodpriorweakp.vector

save(CA_top_goodpriorweaksamples, file="CA_top_goodpriorweaksamples.RData")
