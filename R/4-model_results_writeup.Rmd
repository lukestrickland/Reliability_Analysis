...
Table 2 contains our statistical tests of excitation and inhibition effects. In the high-reliability condition, we find strong evidence of both. In the low-reliability condition,
we found relatively stronger evidence of inhibition effects.
...
Threshold estimates are plotted in Figure 9. Statistical tests of differences across automated and manual conditions in thresholds are tabulated in Table 3. Consistent with Strickland et al. (2021), low-reliability automation had relatively little effect on thresholds, although there were some relatively small drops in threshold levels compared with the manual condition. In contrast, thresholds decreased more in the high-reliability condition, suggesting that participants potentially became less cautious as they
